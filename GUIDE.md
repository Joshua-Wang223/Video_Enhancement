...
后端脚本：`external/IFRNet/process_video_v6_4_5_1_single.py`（IFRNet **v6.4.5.1**）。默认使用 `model_name` 自动拼接 `base_dir/models_IFRNet/checkpoints/<name>.pth`，也可用 `model_path` 指定绝对路径。
