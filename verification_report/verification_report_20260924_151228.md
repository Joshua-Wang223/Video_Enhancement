...
| WARN | R7 | NVENC 环境探测（不依赖 torch） | ffmpeg lavfi h264_nvenc 单帧编码探测（吸收自 verify_post_run） | h264_nvenc ffmpeg 探测失败: [h264_nvenc @ 0000000002a4b4c0] Cannot load nvcuda.dll [vost#0:0/h264_nvenc @ 0000000002a4b280] [enc:h264_nvenc @ 0000000002a38a80] Error while opening encoder  |
