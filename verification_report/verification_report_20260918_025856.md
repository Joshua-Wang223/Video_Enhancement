...
| PASS | BEH-B5 | 重编码合并成功 | 行为执行 | （⚠️[merge] 告警为预期触发，已捕获：⚠️  [merge] 输出容器与编码策略不匹配，实际输出: /tmp/tmp243mxhr_/out.mp4 (请求: /tmp/tmp243mxhr_/out.mkv) |
| PASS | BEH-B6 | actual_output 已回传 | 行为执行 | actual=['/tmp/tmp243mxhr_/out.mp4'] |
