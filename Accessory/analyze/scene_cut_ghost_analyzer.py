#!/usr/bin/env python
"""scene_cut_ghost_analyzer.py —— 扫描分段所有切镜处的插值帧质量，量化鬼影总量。
...
用法:
  python Accessory/analyze/scene_cut_ghost_analyzer.py 1        # 扫 r2_artifacts 的 segment_001
  python Accessory/analyze/scene_cut_ghost_analyzer.py 1 20 --pkg /path/to/artifacts
  python Accessory/analyze/scene_cut_ghost_analyzer.py --src a.mp4 --out b.mp4
"""
import argparse
import os
import re
