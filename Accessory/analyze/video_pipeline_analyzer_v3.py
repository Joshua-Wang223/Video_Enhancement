...
===============================================================
基于 video_pipeline_analyzer.py 升级：
...
用法:
    python video_pipeline_analyzer_v3.py <log_file> [log_file2 ...] [选项]

示例:
    python video_pipeline_analyzer_v3.py temp/output28-9.txt
    python video_pipeline_analyzer_v3.py temp/output28-9.txt temp/output28-10.txt --workers 8
    python video_pipeline_analyzer_v3.py temp/output28-9.txt --parallel process --task-ram-mb 512
    python video_pipeline_analyzer_v3.py temp/output28-9.txt --segments-dir ./segments --skip-ffmpeg
    python video_pipeline_analyzer_v3.py temp/output28-9.txt --hwaccel cuda --gpu-workers 2
    python video_pipeline_analyzer_v3.py temp/output28-9.txt --hwaccel off  # 纯 CPU 取证模式
    python video_pipeline_analyzer_v3.py temp/output28-9.txt --skip-ffprobe-frames  # 跳过慢速帧统计
"""
