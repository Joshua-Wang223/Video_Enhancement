...
用法:
    python video_pipeline_analyzer_v2.py <log_file> [log_file2 ...] [选项]

示例:
    python video_pipeline_analyzer_v2.py temp/output28-9.txt
    python video_pipeline_analyzer_v2.py temp/output28-9.txt temp/output28-10.txt --workers 8
    python video_pipeline_analyzer_v2.py temp/output28-9.txt --parallel process --task-ram-mb 512
    python video_pipeline_analyzer_v2.py temp/output28-9.txt --segments-dir ./segments --skip-ffmpeg
"""
