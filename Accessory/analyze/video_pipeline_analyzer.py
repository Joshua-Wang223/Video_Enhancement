...
视频增强流水线 全流程检测分析脚本
=================================
合并 video_ifrnet_analyzer.py / video_realesrgan_analyzer.py 为全自动全流程分析：
...
用法:
    python video_pipeline_analyzer.py <log_file> [--suffix X] [--skip-ffmpeg] ...

示例:
    python video_pipeline_analyzer.py temp/output28-9.txt
    python video_pipeline_analyzer.py temp/output28-9.txt --segments-dir ./segments --skip-ffmpeg
"""
