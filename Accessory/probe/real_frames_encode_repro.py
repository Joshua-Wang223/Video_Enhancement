...
与 Accessory/probe/ifrnet_lookahead_repro.py 的区别：输入是真实视频帧而非合成噪声，
会走真实的参数集/帧序/码率分布路径。

用法:
  python Accessory/probe/real_frames_encode_repro.py -i benchmark_output/xxx.mp4 --codec hevc --la 8
  python Accessory/probe/real_frames_encode_repro.py -i benchmark_output/xxx.mp4 --codec h264 --la 8
"""
import argparse
import subprocess
import sys
