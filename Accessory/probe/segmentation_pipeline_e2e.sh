#!/usr/bin/env bash
# =============================================================================
# segmentation_pipeline_e2e.sh — 分段全流程测试脚本
# =============================================================================
# 测试范围:
...
#
# 使用方法:
#   chmod +x Accessory/probe/segmentation_pipeline_e2e.sh
#   ./Accessory/probe/segmentation_pipeline_e2e.sh [选项] [<test_video.mp4>] [<output_dir>]
#
#   选项:
