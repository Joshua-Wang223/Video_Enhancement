...
用法：
  python nvenc_vbr_hq_offsets_probe.py [--gpu 0] [--verbose]
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            Examples:
              python nvenc_vbr_hq_offsets_probe.py
              python nvenc_vbr_hq_offsets_probe.py --verbose
              python nvenc_vbr_hq_offsets_probe.py --gpu 1
        """),
    )
