...
用法
----
  python nvenc_la_frame_conservation_suite.py --frames 687 --la-depth 8 --rate-mode vbr_hq
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python nvenc_la_frame_conservation_suite.py
  python nvenc_la_frame_conservation_suite.py --frames 200 --la-depth 8
  python nvenc_la_frame_conservation_suite.py --frames 687 --la-depth 8 --ffmpeg-ref
        """)
