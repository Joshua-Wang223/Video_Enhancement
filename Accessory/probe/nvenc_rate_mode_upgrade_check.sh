#!/usr/bin/env bash
# =============================================================================
# nvenc_rate_mode_upgrade_check.sh — rate_mode/lookahead 统一控制升级 完整测试脚本
# =============================================================================
# 测试范围:
...
#
# 使用方法:
#   chmod +x Accessory/probe/nvenc_rate_mode_upgrade_check.sh
#   ./Accessory/probe/nvenc_rate_mode_upgrade_check.sh [--input <test_video.mp4>] [<test_video.mp4>] [<output_dir>]
#
#   选项:
