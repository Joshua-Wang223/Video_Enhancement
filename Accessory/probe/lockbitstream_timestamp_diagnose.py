...
用法 (Linux 生产 / 任意带 NVENC 的 GPU):
  python Accessory/probe/lockbitstream_timestamp_diagnose.py            # LA=0 快速验证
  python Accessory/probe/lockbitstream_timestamp_diagnose.py --la 8     # LA=8 复现生产段1场景
  python Accessory/probe/lockbitstream_timestamp_diagnose.py --la 8 --frames 24 --sweep-end 256
...
# ═══════════════════════════════════════════════
# H.264 slice frame_num 解析（从 Accessory/verify/segment_bitstream_verify_v2.py 移植）
# ═══════════════════════════════════════════════
class _BitReader:
