#!/usr/bin/env python
"""cuda_context_probe.py —— CUDA context push/pop/setCurrent 语义探针（非侵入）。
...
用法:
  python Accessory/probe/cuda_context_probe.py depth --torch
  python Accessory/probe/cuda_context_probe.py seq --torch
  python Accessory/probe/cuda_context_probe.py sim --cycles 20
  python Accessory/probe/cuda_context_probe.py real --cycles 5 --codec hevc --la 8
"""
import argparse
import ctypes
import sys
