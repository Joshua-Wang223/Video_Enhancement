...
用法:
    python ifrnet_versions_benchmark.py -i test.mp4 -o benchmark_output/
    python ifrnet_versions_benchmark.py -i test.mp4 -o benchmark_output/ --scale 4 --model IFRNet_L_Vimeo90K
"""
...
示例:
    python ifrnet_versions_benchmark.py -i test.mp4 -o benchmark_output/
    python ifrnet_versions_benchmark.py -i test.mp4 -o benchmark_output/ --scale 4
    python ifrnet_versions_benchmark.py -i test.mp4 -o benchmark_output/ --versions v6.3.5 v6.4.3
""",
    )
