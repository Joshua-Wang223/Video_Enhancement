...
用法:
  单文件: python Accessory/verify/segment_bitstream_verify_v2.py <video.mp4> [--dump-nal temp/nal.txt]
  多文件: python Accessory/verify/segment_bitstream_verify_v2.py a.mp4 b.mp4 c.mp4 --workers 4
  文件夹: python Accessory/verify/segment_bitstream_verify_v2.py ./segments/ --hwaccel cuda --gpu-workers 2
  混合:   python Accessory/verify/segment_bitstream_verify_v2.py a.mp4 ./dir1/ b.mp4
"""
import argparse
import math
import os
...
示例：
  python Accessory/verify/segment_bitstream_verify_v2.py a.mp4
  python Accessory/verify/segment_bitstream_verify_v2.py ./segments --hwaccel cuda --gpu-workers 4
  python Accessory/verify/segment_bitstream_verify_v2.py a.mp4 ./dir1/ b.mp4 --workers 8 --hwaccel auto
''',
    )
