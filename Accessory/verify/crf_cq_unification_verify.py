...
# -*- coding: utf-8 -*-
"""
crf_cq_unification_verify.py — 编码质量参数（CRF/CQ）统一优化 · Linux/GPU 实测验证
================================================================================
...
--------
    ...
    python Accessory/verify/crf_cq_unification_verify.py --quick
    ...
    python Accessory/verify/crf_cq_unification_verify.py --gpu --no-br-high
    ...
    python Accessory/verify/crf_cq_unification_verify.py --gpu --jobs 8
    python Accessory/verify/crf_cq_unification_verify.py --gpu --jobs 1   # 强制串行，复现旧行为
...
def render_markdown(ctx: Ctx, v: Verifier, argv: Sequence[str]) -> str:
    ...
    _cmd = " ".join(["python", "Accessory/verify/crf_cq_unification_verify.py", *argv])
    L.append(f"- 命令：`{_cmd}`")
