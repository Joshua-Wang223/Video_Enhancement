...
用法:
  python nvenc_rcparams_offset_verify.py                          # 自动查找 nvEncodeAPI.h
  python nvenc_rcparams_offset_verify.py /path/to/nvEncodeAPI.h   # 指定头文件
  python nvenc_rcparams_offset_verify.py --fetch                  # 自动下载最新头文件后解析
"""
...
def main():
    ...
    if not header:
        ...
        print("   用法: python nvenc_rcparams_offset_verify.py [path/to/nvEncodeAPI.h]")
        print("         python nvenc_rcparams_offset_verify.py --fetch  (自动下载)")
        return 1
