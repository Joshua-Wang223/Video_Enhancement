...
class NVENCEncoder:
    ...
    def __init__(self, width: int, height: int, fps: float,
        ...
        # [FIX-T3-V643-VBR] NV_ENC_RC_PARAMS at offset 40 in NV_ENC_CONFIG
        # NV_ENC_RC_PARAMS uses a UNION for RC-mode-specific params:
        #   version@0, rateControlMode@4, union@8{
        #     constQP: {qpInterP@8, qpInterB@12, qpIntra@16, ...}
        #     vbr:     {averageBitRate@8, maxBitRate@12}
        #   }, multiPass@28, ...
        # 使用 CONSTQP 模式以匹配 Level 2 的 -cq:v 行为
        ...
        _qp_val = max(1, qp) if qp > 0 else 28      # 用户 --crf → QP，若未指定则默认 QP=28
