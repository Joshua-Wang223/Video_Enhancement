    ...
    while i < len(frames):
        ...
        try:
            ...
            outputs, gfpgan_batch_size = _process_batch(
                ...
                face_enhancer, face_fp16, gfpgan_weight, gfpgan_batch_size,  # [FIX-6/8/ADAPT] 透传
            )
            ...
            if 'out of memory' in str(e).lower():
                ...
                if not in_oom_cascade:
                    ...
                    in_oom_cascade = True
                if bs <= 1:
                    # [BUG-3 FIX] RuntimeError OOM 也需要 bs=1 深度清理，与 OutOfMemoryError 分支对齐
...
def inference_video_single(args, video_save_path: str, device=None):
    ...
    # [BUG-1 FIX] programmatic 调用兼容：use_compile 默认 True，与 main() 保持一致
