...
示例:
    ...
    python benchmark_ifrnet_versions_v2.py -i test.mp4 -o benchmark_output/ --versions v6.4.5.1 --no-warmup
    python benchmark_ifrnet_versions_v2.py -i test.mp4 -o benchmark_output/ --codec libx264 h264_nvenc
    python benchmark_ifrnet_versions_v2.py -i test.mp4 -o benchmark_output/ --versions v6.4.5.1 --la 0 8
    python benchmark_ifrnet_versions_v2.py -i test.mp4 -o benchmark_output/ --rate-mode constqp vbr_hq qvbr
""",
    )
