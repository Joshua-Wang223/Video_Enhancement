#!/usr/bin/env python
"""analyze_interp_ghost.py —— 定位分段插帧产物的「水彩画样润开」帧来源。
...
用法:
  python tests/analyze_interp_ghost.py --seg 1 --around 414,2060,1938
  python tests/analyze_interp_ghost.py --seg 0 --around 10420 --scan 0:600:2
  python tests/analyze_interp_ghost.py --src a.mp4 --out b.mp4 --around 413
"""
import argparse
import os
import subprocess
