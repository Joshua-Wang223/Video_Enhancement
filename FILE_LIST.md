...
| 文件 | 状态 | 说明 |
|------|------|------|
| `ifrnet_processor_v6_1_single.py` | ★ **当前** | IFRNet 插帧；底层 **`external/IFRNet/process_video_v6_4_5_1_single.py`（v6.4.5.1）** |
...
| 文件 | 状态 | 说明 |
|------|------|------|
| `process_video_v6_4_5_1_single.py` | ★ **当前后端** | 单卡 IFRNet 推理主实现（**v6.4.5.1**，NVENC SDK Level 1 GPU 直通 + CE-Pipeline；当前处理器默认对接） |
