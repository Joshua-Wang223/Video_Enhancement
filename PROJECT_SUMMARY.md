...
└────────────────────────────┬────────────────────────────────┘
    ...
    │ v6_4_5_1_single.py    │       │   create_video_enhancer()     │
...
| IFRNet 处理器 | `src/processors/ifrnet_processor_v6_1_single.py` | 对接 `process_video_v6_4_5_1_single.py` |
| Real-ESRGAN 处理器 | `src/processors/realesrgan_processor_video_optimized.py` | 动态加载并调用 `realesrgan_video/main.py` |
| IFRNet 后端 | `external/IFRNet/process_video_v6_4_5_1_single.py` | 当前默认后端版本（v6.4.5.1，NVENC SDK Level 1 + CE-Pipeline） |
...
| 文件 | 说明 |
|------|------|
| `process_video_v6_4_5_1_single.py` | **当前对接**（v6.4.5.1，NVENC SDK Level 1 GPU 直通 + CE-Pipeline） |
...
main_video_optimized.py
  ...
  │     └── external/IFRNet/process_video_v6_4_5_1_single.py
